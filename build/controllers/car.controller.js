        ...
        this.find = function (_request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.carService.find()];
                    case 1:
                        data = _a.sent();
        ...
        this.create = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.carService.save(req.body)];
                    case 1:
                        data = _a.sent();
        ...
        this.update = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.carService.update(req.params.id, req.body)];
                    case 1:
                        data = _a.sent();
                        res.status(200).json({ data: data });
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.carService.read(id, ["station"])];
                    case 1:
                        data = _a.sent();
                        response.status(200).json({ data: data });
                        return [3 /*break*/, 3];
