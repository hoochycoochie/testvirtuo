...
describe('Car service ', function () {
    ...
    var car = null;
    var carService = new car_service_1.CarService();
    it('can be created correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, carService.save(carData)];
                case 1:
                    car = _a.sent();
                    expect(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, car._id];
                    }); }); }).toBeDefined();
                    return [2 /*return*/];
            }
        });
    }); });
    it('can read Car by id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var CarFound;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, carService.read(car._id)];
                case 1:
                    CarFound = _a.sent();
    ...
    it('can update Car', function () { return __awaiter(void 0, void 0, void 0, function () {
        var data, carUpdated;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    data = { email: 'toto1@live.fr' };
                    return [4 /*yield*/, carService.update(car._id, data)];
                case 1:
                    carUpdated = _a.sent();
    ...
    it('can find list of Cars', function () { return __awaiter(void 0, void 0, void 0, function () {
        var cars;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, carService.find()];
                case 1:
                    cars = _a.sent();
    ...
    it('can be removed', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, carService.remove(car._id)];
                case 1:
                    removedService = _a.sent();
    ...
    it('name should be at least 3 characters', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, carService.save({ name: 'a' })];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('name should be unique at least 3 characters', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, carService.save({ name: 'abcd' })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, carService.save({ name: 'abcd' })];
                case 2:
